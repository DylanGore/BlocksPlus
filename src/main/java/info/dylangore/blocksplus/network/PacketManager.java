package info.dylangore.blocksplus.network;
...
public class PacketManager {
    ...
    public static void init()
    {
        ...
        codec.addDiscriminator(0, PacketMimic.class);

        channels.putAll(NetworkRegistry.INSTANCE.newChannel("BlocksPlus", codec, new HandlerServer()));
    ...
    private static final class Codec extends FMLIndexedMessageToMessageCodec<PacketBase>
    {
        ...
        public FMLIndexedMessageToMessageCodec<PacketBase> addDiscriminator(int discriminator, Class<? extends PacketBase> type)
        {
            ...
            {
                LogHelper.log(Level.FATAL, type.getName() + "does not have an empty constructor!");
            }
