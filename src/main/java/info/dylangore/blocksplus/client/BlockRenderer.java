package info.dylangore.blocksplus.client;
import info.dylangore.blocksplus.blocks.BlockMimic;
...
public class BlockRenderer implements ISimpleBlockRenderingHandler
{
    ...
    {
        return renderID == BPBlocks.render3DId;
    }
    ...
    private static boolean renderFullCamo(IBlockAccess world, int x, int y, int z, RenderBlocks renderblocks, Block block)
    {
        ...
        // get Copied ID
        Block fakeBlock = ((TileEntityMimic) world.getTileEntity(x, y, z)).getCopyBlock();
        if (fakeBlock == null)
    ...
    private static boolean renderOneSideCamo(IBlockAccess blockAccess, int i, int j, int k, RenderBlocks renderblocks, Block block)
    {
        ...
        // get Copied Texture
        TileEntityMimic entity = (TileEntityMimic) blockAccess.getTileEntity(i, j, k);
