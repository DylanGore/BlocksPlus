//package dylangore.mods.blocksplus.handler;
//
...
//
//	    int maxYcoord = 60 + random.nextInt(63);
//	    int veinSize = 32 + random.nextInt(128);
//
//	    for(int meta = 0; meta < BlockInfo.COLOR_STONE_NAMES.length; meta ++){
//	    	(new WorldGenMinable(BPBlocks.colorStone.blockID,meta, veinSize, Block.stone.blockID)).generate(world, random, Xcoord, maxYcoord, Zcoord);
//	    }
//
//
//
