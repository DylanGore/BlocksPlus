...
public class BPBlocks {
	...
	public static void regBlocks(){
		...
		for(int meta = 0; meta < BlockInfo.colorBlockNames.length; meta ++){
            ...
            OreDictionary.registerOre("stonebrick", new ItemStack(colorStoneBricks, 1, meta));
            OreDictionary.registerOre("stonebrick_moss", new ItemStack(colorStoneBricksMoss, 1, meta));
            OreDictionary.registerOre("stonebrick_cracked", new ItemStack(colorStoneBricksCracked, 1, meta));
            OreDictionary.registerOre("stonebrick_chiseled", new ItemStack(colorStoneBricksChiseled, 1, meta));
		}
	}
