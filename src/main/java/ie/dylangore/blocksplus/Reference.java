...
public class Reference {
    ...
    public static String getColorNameCap(String unlocalizedColorName) {
        String capName;
        capName = unlocalizedColorName.substring(0, 1).toUpperCase() + unlocalizedColorName.substring(1);
        return capName;
    }
